...
public class Stringfunktionen {
	public static void main(String[] args) {
		  ...
		  boolean eq = test.equals("happy"); // false, prüft auf Gleichheit, kein ==
		  boolean em = test.isEmpty(); // false, prüft auf Leerstring
		  int length = test.length(); // Länge des Strings
		  boolean start = test.startsWith("un"); // true, prüft ob String mit "un" anfängt
		  boolean end = test.endsWith("y"); // true, prüft ob String mit "y" aufhört
		  ...
		  String upper = test.toUpperCase(); // "UNHAPPY", zu Großbuchstaben
		  ...
		  System.out.println("test.toUpperCase(2)\t Erwartet: UNHAPPY\t" + "Ergebnis: " + upper);
